...
<div id="receiveArea" style="background: black; color: lime; padding: 10px; margin: 10px 0; border-radius: 5px; min-height: 40px; display: none;">
	...
	<div>
        ...
        <div class="section">
            ...
            <button type="button" class="load-data-button" onclick="loadData()" tabindex="27" role="button" aria-label="Load Data">📂 Load Data</button>
            ...
            <button type="button" class="import-bib-list-button" onclick="importBibList()" tabindex="29" role="button" aria-label="Import Bib List">📥 Import Bib List</button>
            ...
            <button type="button" class="sync-button" onclick="syncOfflineEntries()" tabindex="31" role="button" aria-label="Sync Offline Entries">🔄 Sync Offline Entries</button><br><br>  
