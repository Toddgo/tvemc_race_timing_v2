...
VALUES
-- 100M (coordinates confirmed)
(5, '100M',  1, 'START',  'Start Line',               0.00,  0, 0,  34.673048, -118.439902),
(5, '100M',  2, 'AS1',    'San Fran #1',              11.00,  1, 0,  34.634579, -118.390101),
(5, '100M',  3, 'AS2',    'Spunky Edison #1',         18.00,  1, 0,  34.609654, -118.363156),
(5, '100M',  4, 'AS3',    'Bouquet Canyon #1',        24.00,  1, 0,  34.583715, -118.321263),
(5, '100M',  5, 'AS4',    'Agua Dulce',               32.50,  1, 0,  34.522733, -118.320232),
(5, '100M',  6, 'AS5',    'Bouquet Canyon #2',        41.50,  1, 0,  34.583715, -118.321263),
(5, '100M',  7, 'AS6',    'Spunky Edison #2',         47.50,  1, 0,  34.609654, -118.363156),
(5, '100M',  8, 'AS7',    'Lincoln Crest',            54.50,  1, 0,  34.583746, -118.321312),
(5, '100M',  9, 'AS8',    'Spunky Edison #3',         61.50,  1, 0,  34.609654, -118.363156),
(5, '100M', 10, 'AS9',    'San Fran #2',              68.00,  1, 0,  34.634579, -118.390101),
(5, '100M', 11, 'AS10',   'Lake Hughes #1',           75.50,  1, 0,  34.659707, -118.460416),
(5, '100M', 12, 'AS11',   'Sawmill Road',             84.00,  1, 0,  34.675882, -118.457792),
(5, '100M', 13, 'AS12',   'Lake Hughes #2',           92.50,  1, 0,  34.659707, -118.460416),
(5, '100M', 99, 'FINISH', 'Finish Line',             100.00,  0, 1,  34.673048, -118.439902),
-- 100K
(5, '100K',  1, 'START',  'Start Line',               0.00,  0, 0,  NULL, NULL),
(5, '100K',  2, 'AS1',    'San Fran #1',               7.50,  1, 0,  NULL, NULL),
(5, '100K',  3, 'AS2',    'Spunky Edison #1',         14.00,  1, 0,  NULL, NULL),
(5, '100K',  4, 'AS3',    'Bouquet Canyon #1',        20.00,  1, 0,  NULL, NULL),
(5, '100K',  5, 'AS4',    'Spunky Edison #2',         26.00,  1, 0,  NULL, NULL),
(5, '100K',  6, 'AS5',    'San Fran #2',              32.50,  1, 0,  NULL, NULL),
(5, '100K',  7, 'AS6',    'Lake Hughes #1',           40.00,  1, 0,  NULL, NULL),
(5, '100K',  8, 'AS7',    'Sawmill Road',             48.25,  1, 0,  NULL, NULL),
(5, '100K',  9, 'AS8',    'Lake Hughes #2',           56.50,  1, 0,  NULL, NULL),
(5, '100K', 99, 'FINISH', 'Finish Line',              62.20,  0, 1,  NULL, NULL),
-- 50M
(5, '50M',  1, 'START',  'Start Line',                0.00,  0, 0,  NULL, NULL),
(5, '50M',  2, 'AS1',    'San Fran #1',                7.50,  1, 0,  NULL, NULL),
(5, '50M',  3, 'AS2',    'Spunky Edison #1',          14.00,  1, 0,  NULL, NULL),
(5, '50M',  4, 'AS3',    'Bouquet Canyon #1',         20.00,  1, 0,  NULL, NULL),
(5, '50M',  5, 'AS4',    'Spunky Edison #2',          26.00,  1, 0,  NULL, NULL),
(5, '50M',  6, 'AS5',    'San Fran #2',               32.50,  1, 0,  NULL, NULL),
(5, '50M',  7, 'AS6',    'Lake Hughes #1',            40.00,  1, 0,  NULL, NULL),
(5, '50M',  8, 'AS7',    'Lake Hughes #2',            44.50,  1, 0,  NULL, NULL),
(5, '50M', 99, 'FINISH', 'Finish Line',               51.20,  0, 1,  NULL, NULL),
-- 50K  (station codes AS1/AS2/AS3 — NOT AS6/AS7/AS8)
(5, '50K',  1, 'START',  'Start Line',                0.00,  0, 0,  NULL, NULL),
(5, '50K',  2, 'AS1',    'Lake Hughes #1',             6.50,  1, 0,  NULL, NULL),
(5, '50K',  3, 'AS2',    'Sawmill Road',              15.00,  1, 0,  NULL, NULL),
(5, '50K',  4, 'AS3',    'Lake Hughes #2',            23.50,  1, 0,  NULL, NULL),
(5, '50K', 99, 'FINISH', 'Finish Line',               30.20,  0, 1,  NULL, NULL),
-- 30K
(5, '30K',  1, 'START',  'Start Line',                0.00,  0, 0,  NULL, NULL),
(5, '30K',  2, 'AS1',    'Lake Hughes #1',             6.50,  1, 0,  NULL, NULL),
(5, '30K',  3, 'TURN',   'Turnaround Spot (NO AID)',   9.00,  0, 0,  NULL, NULL),
(5, '30K',  4, 'AS2',    'Lake Hughes #2',            12.50,  1, 0,  NULL, NULL),
(5, '30K', 99, 'FINISH', 'Finish Line',               18.00,  0, 1,  NULL, NULL);
